...
public class Restangle {
    ...
    // Для определенности принимаем допущение, что стороны прямоугольника параллельны координатным осям.
    // Иначе для данных двух точек можно нарисовать бесконечное количество прямоугольников с разным "наклоном" :)
    public double area() {
